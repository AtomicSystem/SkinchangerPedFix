local Components = {
	...
	{label = _U('hair_1'),					name = 'hair_1',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65,  skipM={ 32,100 }, skipF={ 57,100 }},
	...
	{label = _U('tshirt_1'),				name = 'tshirt_1',			value = 0,		min = 0, 	zoomOffset = 0.75,		camOffset = 0.15, skipM={ 32,100 }, skipF={ 26,100 }},
	{label = _U('tshirt_2'),				name = 'tshirt_2',			value = 0,		min = 0, 	zoomOffset = 0.75,		camOffset = 0.15,	textureof	= 'tshirt_1'},
	{label = _U('torso_1'),					name = 'torso_1',			value = 0,		min = 0, 	zoomOffset = 0.75,		camOffset = 0.15, skipM={ 75,100 }, skipF={ 73,100 }},
	{label = _U('torso_2'),					name = 'torso_2',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	textureof	= 'torso_1'},
	{label = _U('decals_1'),				name = 'decals_1',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15, skipM={ 7,100 }, skipF={ 7,100 }},
	...
	{label = _U('pants_1'),					name = 'pants_1',			value = 0,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5, skipM={ 31,100 }, skipF={ 42,100 }},
	{label = _U('pants_2'),					name = 'pants_2',			value = 0,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5,	textureof	= 'pants_1'},
	{label = _U('shoes_1'),					name = 'shoes_1',			value = 0,		min = 0,	zoomOffset = 0.8,		camOffset = -0.8, skipM={ 33,100 }, skipF={ 26,100 }},
	...
	{label = _U('bproof_1'),				name = 'bproof_1',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15, skipM={ 9,100 }, skipF={ 7,100 }},
	{label = _U('bproof_2'),				name = 'bproof_2',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	textureof	= 'bproof_1'},
	{label = _U('chain_1'),					name = 'chain_1',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65, skipM={ 18,100 }, skipF={ 15,100 }},
	{label = _U('chain_2'),					name = 'chain_2',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65,	textureof	= 'chain_1'},
	{label = _U('helmet_1'),				name = 'helmet_1',			value = -1,		min = -1,	zoomOffset = 0.6,		camOffset = 0.65,	componentId	= 0, skipM={ 20,100 }, skipF={ 20,100 }},
	...
	{label = _U('watches_1'),				name = 'watches_1',			value = -1,		min = -1,	zoomOffset = 0.75,		camOffset = 0.15, skipM={ 1,100 }, skipF={ 1,100 }},
	...
	{label = _U('bag'),						name = 'bags_1',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15, skipM={ 9,100 }, skipF={ 8,100 }},
